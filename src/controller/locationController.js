...
export const getProvince = async (request, response, next) => {
  try {
...
export const getCity = async (request, response, next) => {
  try {
    const request_data = {
...
export const getDistrict = async (request, response, next) => {
  try {
    const request_data = {
...
export const getSubdistrict = async (request, response, next) => {
  try {
    const request_data = {
